...
class Rectangle:
    ...
    def square(cls, size=0):
        """
        Create a new instance of `Rectangle` with equal dimensions

        Args:
            size: size will be the width and height of the Rectangle
                    hence `square`

        Return:
            A new instance of `Rectangle` with equal dimensions
        """
